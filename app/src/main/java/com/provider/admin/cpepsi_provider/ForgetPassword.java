...
public class ForgetPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        em_provider = (EditText)findViewById(R.id.em_provider);
        bt_submit = (Button)findViewById(R.id.bt_submit);

        bt_submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               Em_provider = em_provider.getText().toString();

               if (Connectivity.isNetworkAvailable(ForgetPassword.this)){

                   if (!Em_provider.isEmpty()) {
                       new PostSave().execute();
                   } else {
                       em_provider.setError("Please Enter Mobile no");
                       em_provider.requestFocus();
                   }
               }else {
...
//                URL url = new URL("https://www.paramgoa.com/cpepsi/api/forgetpassword");
                ...
                postDataParams.put("mobile_no", Em_provider);
